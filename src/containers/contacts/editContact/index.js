        ...
        return (
            <KeyboardAwareScrollView style={{ flex: 1 }} >
                ...
                <Button
                    title="submit"
                    onPress={() => {
                        this.props.editContact({ first_name, last_name, gender, phone_no, address }, this.state.photo, this.props.navigation, "native")
                    }}
                />
...
export default connect(mapStateToProps, { submitContact, editContact })(CreateContact)